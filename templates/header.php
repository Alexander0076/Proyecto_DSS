...
<head>
    ...
    <meta name="stafport" content="width=device-width, initial-scale=1.0">
...
<nav class="nav" style="margin-left: 20%;">
    <ul>
        <li><a href="../staff/evento.php">Evento</a></li>
        <li>
        <div class="btn-group">
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="../staff/evento.php#">Inicio</a>
  </div>
</div>
